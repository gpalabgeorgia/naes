    ...
    <div class="span9">
        ...
        <div class="row">
            ...
            <div class="span6">
                ...
                <hr class="soft"/>
                <small>{{ $total_stock }} ცალი მარაგში</small>
                <form action="{{ url('add-to-cart') }}" method="post" class="form-horizontal qtyFrm">@csrf
                    ...
                    <div class="control-group">
                        ...
                        <button type="submit" class="btn btn-large btn-primary pull-right"> დამატება <i class=" icon-shopping-cart"></i></button>
                    </div>
            </form>
            ...
            <a class="btn btn-small pull-right" href="#detail">დეტალურად</a>
            <br class="clr"/>
        ...
        <div class="span9">
            <ul id="productDetail" class="nav nav-tabs">
                <li class="active"><a href="#home" data-toggle="tab">პროდუქტის დეტალები</a></li>
                <li><a href="#profile" data-toggle="tab">მსგავსი პროდუქტები</a></li>
            </ul>
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade active in" id="home">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                        <tr class="techSpecRow"><th colspan="2">პროდუქტის დეტალები</th></tr>
                        <tr class="techSpecRow"><td class="techSpecTD1">ბრენდი: </td><td class="techSpecTD2">{{ $productDetails['brand']['name'] }}</td></tr>
                        <tr class="techSpecRow"><td class="techSpecTD1">კოდი:</td><td class="techSpecTD2">{{ $productDetails['product_code'] }}</td></tr>
                        <tr class="techSpecRow"><td class="techSpecTD1">ფერი:</td><td class="techSpecTD2">{{ $productDetails['product_color'] }}</td></tr>
                        ...
                        @if(!empty($productDetails['pattern']))
                            <tr class="techSpecRow"><td class="techSpecTD1">ნახატით:</td><td class="techSpecTD2">{{ $productDetails['pattern'] }}</td></tr>
                        @endif
                            ...
                            @foreach($relatedProducts as $product)
                                <div class="row">
                                    ...
                                    <div class="span4">
                                        ...
                                        <a class="btn btn-small pull-right" href="{{ url('product/'.$product['id']) }}">დეტალურად</a>
                                        <br class="clr"/>
                                    </div>
                                    <div class="span3 alignR">
                                        <form class="form-horizontal qtyFrm">
                                            ...
                                            <label class="checkbox">
                                                <input type="checkbox">  დაამატე შესადარებლად
                                            </label><br/>
                                            <div class="btn-group">
                                                <a href="product_details.html" class="btn btn-large btn-primary"> დამატება <i class=" icon-shopping-cart"></i></a>
